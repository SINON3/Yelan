...
async def next_page(bot, query):
    ...
    btn.insert(0,
        [
            InlineKeyboardButton(text="Hanime Channel", url='https://t.me/HaremHanimes')
        ]
    )
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Hanime Channel', url='https://t.me/HaremHanimes'),
            InlineKeyboardButton('Anime Channel', url='https://t.me/Anime_NightFall')
        ], [
